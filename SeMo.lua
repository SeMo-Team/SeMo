...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/SeMoTEAM/Files_SeMo/master/File_Bot/commands.lua") 
...
SeMo_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
SeMo_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
SeMo_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
SeMo_Msg = 'امبروطور التفاعل' 
...
--------------------------------------------------------------------------------------------------------------
function SourceSeMo(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,SeMo_Msg) 
return false  
end 
if text then    
...
os.execute('wget https://raw.githubusercontent.com/SeMo-Team/SeMo/master/SeMo.lua')
send(msg.chat_id_, msg.id_,' ✸∫ تم تحديث السورس \n ✸∫ لديك اخر اصدار لسورس سيمو\n ✸∫ الاصدار » { 1.3v}')
dofile('SeMo.lua')  
end
if text == 'الاصدار ✸' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✸∫ اصدار سورس سيمو \n ✸∫ الاصدار »{ 1.3v}')
end
...
send(msg.chat_id_, msg.id_,'✸∫  عدد الكروبات الان » { '..#group..' }'..SeMok..''..SeMo..'\n✸∫  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
local SeMo1_Msg = database:get(bot_id.."SeMo1:Add:Filter:Rp2"..text..msg.chat_id_)   
if SeMo1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✸∫ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'xxxc_x')..') \n ✸∫ '..SeMo1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if SeMo_Msg and not Special(msg) then  
local SeMo_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if SeMo_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
send(msg.chat_id_,0, " ✸∫ عذرا » {["..data.first_name_.."](T.ME/xxxc_x)}\n ✸∫ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
≪━━━━━━━━━━━━━≫
 ✸∫ ↬SeMo TEAM
 ≪━━━━━━━━━━━━━≫
 ✸∫ ↬[Channel SeMo](t.me/xxxc_x) 
≪━━━━━━━━━━━━━≫
 ✸∫ ↬[Information](t.me/pvv_v)
≪━━━━━━━━━━━━━≫
 ✸∫ ↬[DEVELOPER](t.me/CCFRR)
≪━━━━━━━━━━━━━≫
 ✸∫ ↬[The way his inauguration](https://t.me/xxxc_x/365)
≪━━━━━━━━━━━━━≫
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ✸∫ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'xxxc_x')..') \n ✸∫ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✸∫ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'xxxc_x')..') \n ✸∫ تـم قفـل التاك بالكتم ')
end,nil)   
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/SeMoTEAM/Files_SeMo/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ✸∫ اهلا بك في متجر ملفات سيمو\n ✸∫ ملفات السورس ↓\n≪━━━━━━━━━━━━━≫\n\n"
...
local json_file, res = https.request("https://raw.githubusercontent.com/SeMoTEAM/Files_SeMo/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('SeMo.lua')  
else
send(msg.chat_id_, msg.id_," ✸∫ عذرا الملف لايدعم سورس سيمو \n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✸∫ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'xxxc_x')..')'
status  = '\n ✸∫ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ✸∫ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ✸∫ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'xxxc_x')..')'
...
database:set(bot_id.."SeMo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."SeMo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ✸∫ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."SeMo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."SeMo1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."SeMo1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."SeMo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ✸∫ تم منع الكلمه مع التحذير")  
database:del(bot_id.."SeMo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."SeMo1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."SeMo1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."SeMo1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ✸∫ ارسل الكلمه الان")  
database:set(bot_id.."SeMo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."SeMo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."SeMo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SeMo1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."SeMo1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."SeMo1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."SeMo1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SeMo1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."SeMo1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ✸∫ قائمة المنع \n≪━━━━━━━━━━━━━≫\n"
for k,v in pairs(list) do  
local SeMo_Msg = database:get(bot_id.."SeMo1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..SeMo_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'سيمو').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'سيمو')
local SeMo_Msg = {
'عمغي 🥺💕.',
'هاا شتريد كافي ☹️.',
'مشايف بوت شني 😂.',
...
send(msg.chat_id_, msg.id_,'['..SeMo_Msg[math.random(#SeMo_Msg)]..']') 
return false
end
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'سيمو').." غادر" or text == 'بوت غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'xxxc_x')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
SeModx(msg.chat_id_, msg.id_, ' ✸∫ ايدي المجموعة » ( '..msg.chat_id_..' )\n ✸∫ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ✸∫ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ✸∫ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'سيمو')
...
SeMo = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(SeMo)
...
------------------------------------------------------------------------
local SeMoAbot = database:get(bot_id.."SeMo1:Add:Filter:Rp2"..text..result.chat_id_)   
if SeMoAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ✸∫ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ✸∫ ["..SeMoAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local SeMo1_Msg = database:get(bot_id.."SeMo1:Add:Filter:Rp2"..text..result.chat_id_)   
if SeMo1_Msg then    
send(msg.chat_id_, msg.id_," ✸∫ "..SeMo1_Msg)
